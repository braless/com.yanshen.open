...
public class DateUtil {
     ...
     *
     * @return 秒数
     * @descrption 注意:上面getMonthSecond方法计算到月底的秒数快了几个小时
     */
//    public static Integer getSecondsNowToEndOfMonth() {
//        Date nowdate = new Date();
//        Long remainSeconds = (cn.hutool.core.date.DateUtil.endOfMonth(nowdate).getTime() - nowdate.getTime()) / 1000L;
//        return remainSeconds.intValue();
//    }
}
