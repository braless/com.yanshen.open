package com.yanshen.common.log.aspect;
...
import com.yanshen.common.log.enums.BusinessStatus;
import com.yanshen.common.log.filter.PropertyPreExcludeFilter;
import com.yanshen.common.log.service.AsyncLogService;
...
public class LogAspect {
    ...
    protected void handleLog(final JoinPoint joinPoint, Log controllerLog, final Exception e, Object jsonResult) {
        try {
            ...
            if (BeanUtil.isNotEmpty(ServletUtils.getRequest()) && StringUtils.isNotBlank(ServletUtils.getRequest().getRequestURI())) {
            ...
            // 设置请求方式
            if (BeanUtil.isNotEmpty(ServletUtils.getRequest()) && StringUtils.isNotBlank(ServletUtils.getRequest().getMethod())) {
    ...
    public void getControllerMethodDescription(JoinPoint joinPoint, Log log, OperLogDto operLog, Object jsonResult) throws Exception {
        ...
        if (log.isSaveResponseData() && StringUtils.isNotNull(jsonResult)) {
            operLog.setJsonResult(StringUtils.substring(Base64StrHook.hookStr(JSON.toJSONString(jsonResult)), 0, 5000));
        }
    }
    ...
    private void setRequestValue(JoinPoint joinPoint, OperLogDto operLog) throws Exception {
        ...
        if (HttpMethod.GET.name().equals(requestMethod)) {
            ...
            operLog.setOperParam(StrUtil.format("{}，params：{} {}", url, params, reqParam));
        }
    }
    ...
    private String argsArrayToString(Object[] paramsArray) {
        ...
        String s = Base64StrHook.hookStr(params);
